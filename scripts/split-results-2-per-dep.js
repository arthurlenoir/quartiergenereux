...
var splitResultsPerDep = function (dep) { return __awaiter(void 0, void 0, void 0, function () {
    var depValue, fileContent, writeStream, isFirst, lines, lastDep;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                depValue = parseInt(dep);
                return [4 /*yield*/, (0, promises_1.readFile)("./data/resultats-definitifs-par-bureau-de-vote-second-tour.csv", "utf8")];
            case 1:
                fileContent = _a.sent();
                writeStream = (0, fs_1.createWriteStream)("./public/data/resultats-2nd-tour-".concat(dep, ".json"));
                writeStream.write("[");
                isFirst = true;
                fileContent;
                ...
                lines.forEach(function (line) {
                    ...
                    if (columns.length === 55) {
                        ...
                        if (parseInt(result.departement) === depValue) {
                            ...
                            if (result.departement !== lastDep) {
                                lastDep = result.departement;
                                console.log("nop", result.departement, parseInt(result.departement));
                            }
                        }
                    }
                });
