...
var splitCommunesPerDepartment = function (dep) {
    (0, stream_chain_1.chain)([
        (0, fs_1.createReadStream)("./data/communes-avec-outre-mer.geojson"),
        ...
        function (_a) {
            var _b;
            var value = _a.value;
            if ((_b = value === null || value === void 0 ? void 0 : value.properties) === null || _b === void 0 ? void 0 : _b.code) {
        ...
        (0, fs_1.createWriteStream)("./public/data/communes-".concat(dep, ".geojson")),
    ]);
