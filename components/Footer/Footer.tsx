    ...
    <footer className={styles.footer}>
      <div className={`${rootStyles.container} ${styles.footerContainer}`}>
        <div className={styles.footerSection}>
          ...
          <ul className={styles.footerSchedule}>
            <li
              className={`${styles.schedule} ${
                day === DAYS.MONDAY ? styles.scheduleToday : ""
              }`}
            >
            ...
            <li
              className={`${styles.schedule} ${
                day === DAYS.TUESDAY ? styles.scheduleToday : ""
              }`}
            >
            ...
            <li
              className={`${styles.schedule} ${
                day === DAYS.WEDNESDAY ? styles.scheduleToday : ""
              }`}
            >
            ...
            <li
              className={`${styles.schedule} ${
                day === DAYS.THURSDAY ? styles.scheduleToday : ""
              }`}
            >
            ...
            <li
              className={`${styles.schedule} ${
                day === DAYS.FRIDAY ? styles.scheduleToday : ""
              }`}
            >
            ...
            <li
              className={`${styles.schedule} ${
                day === DAYS.SATURDAY ? styles.scheduleToday : ""
              }`}
            >
            ...
            <li
              className={`${styles.schedule} ${
                day === DAYS.SUNDAY ? styles.scheduleToday : ""
              }`}
            >
          ...
          <address>
            <a
              href="mailto:contact@quartiergenereux.fr"
              className={styles.contactLink}
            >
              contact@quartiergenereux.fr
            </a>
            <a
              href="https://www.google.fr/maps/place/Quartier+G%C3%A9n%C3%A9reux/@43.6159593,3.8725947,17z/data=!3m1!4b1!4m5!3m4!1s0x12b6af3f476bf623:0x1e15ffecd0c43d07!8m2!3d43.6159593!4d3.8747834?shorturl=1"
              rel="noreferrer"
              target="_blank"
              className={styles.contactLink}
            >
        ...
        <div className={styles.footerSection}>
          ...
          <figure className={styles.mapFigure}>
            <Image
              className={styles.mapFigureImage}
              src="/plan-quartier-genereux.svg"
              fill
              alt="Plan d'accès au Quartier Généreux"
            />
          </figure>
        </div>
      </div>
